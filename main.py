...
# WITH OVERLAP
BACK_IMAGE_FILENAME = 'img/memchu_big_fore.jpg'
FORE_IMAGE_FILENAME = 'img/memchu_overlap_back.jpg'

# FAR AWAY
#BACK_IMAGE_FILENAME = '../ee368/images/oval1.jpg'
#FORE_IMAGE_FILENAME = '../ee368/images/oval2.jpg'

# OTHER
#BACK_IMAGE_FILENAME = '../ee368/pack1.jpg'
#FORE_IMAGE_FILENAME = '../ee368/pack2.jpg'
...
def colorcorrect(img1,img2):
    ...
    cv2.imshow('color corrected front image', concat_image)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    
    concat_image = np.concatenate((back_image, back_corr), axis=1)
    cv2.imshow('color corrected back image', concat_image)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
...
def blend_cropped_image(background_img, cropped_img):
    ...
    cv2.imshow('binarized cropped image', concat_image)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cropped_img
    cv2.imshow('original merged image', merged_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
